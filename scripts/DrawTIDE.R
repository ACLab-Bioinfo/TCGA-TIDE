...
DrawTIDE <- function(gene){
  ...
  for(i in c("15","25","30")){
    ...
    ### Dysfunction score
    pdf(paste0("./output_figure/", gene, "/", i, "_Percent/Vlnplot.Dysfunctionscore.pdf"), width = 4, height = 4)
    ...
    ### Exclusion score
    pdf(paste0("./output_figure/", gene, "/", i, "_Percent/Vlnplot.Exclusionscore.pdf"), width = 4, height = 4)
    ...
    ### MDSC score
    pdf(paste0("./output_figure/", gene, "/", i, "_Percent/Vlnplot.MDSCscore.pdf"), width = 4, height = 4)
    ...
    col <- c("#EE3B3B", "#0000EE")
    x <- 1:nrow(file)
    pdf(paste0("./output_figure/", gene, "/", i, "_Percent/Waterfullplit.TDEscore.pdf"), width = 8, height = 4)
