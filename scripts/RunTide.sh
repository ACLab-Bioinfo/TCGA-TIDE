...
Output_file1="./output_TIDE/${gene}/TIDE.output.first_last_15_normalized.${gene}.txt"
Output_file2="./output_TIDE/${gene}/TIDE.output.first_last_25_normalized.${gene}.txt"
Output_file3="./output_TIDE/${gene}/TIDE.output.first_last_30_normalized.${gene}.txt"
